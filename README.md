...
| | |
|---|---|
| 🎮 Приложение | `https://ЗАМЕНИ-НА-СВОЙ.web.app` |
...
<sub>Папка репозитория исторически называется `samara-go` — проект начинался для Самары и
переехал в Санкт-Петербург; имя приложения — **Piter-Go**.</sub>
